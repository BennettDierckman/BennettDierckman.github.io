...
if (strlen($_POST['password']) < 6) {
    ...
    if ( $result->num_rows > 0 ) {
        ...
        if ( $mysqli->query($sql) ){
            ...
            $_SESSION['message'] = "Account Registered, please wait for admin authorization before logging in.";
            ...
            https://mjyintl.com/Good_Grocery_Template/php/verify.php?email=".$email."&hash=".$hash;  
