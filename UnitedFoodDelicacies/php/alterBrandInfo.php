...
<head>
    <title>Dashboard | Edit Brand Name</title>
    <meta charset="utf-8">
    ...
    <div class="crat">
      ...
      <div class="row mt-5 mt-lg-0">
        <div class="col-12 mx-auto" style="background-color: #F2f3f4;">
          ...
          <h3 class="text-center mt-4 mb-2">Rename Existing Brand Name</h3>
          <p class="mb-3 mx-auto mt-0" style="max-width:550px;"><span style="text-decoration:underline;">IMPORTANT:</span> Changing the name of this brand will also change the brand name of existing products that already have this brand assigned to them.</p>
          <form method="post" action="enterNewBrandInfo.php">
            <div class="form-group mb-4">
              <input type="text" class="form-control" placeholder="Brand&rsquo;s new name" style="max-width: 350px; margin-left:auto; margin-right:auto;"  name="newBrandName" required>
            </div>
            <div class="row mt-2 mb-4">
              <div class="col-6 px-auto d-flex justify-content-end">
                <?php
                  echo '<a href="manageBrands.php" class="btn btn-secondary">Go Back</a>';
                ?>
              </div>
