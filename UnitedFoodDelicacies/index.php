  ...
  <body>
    ...
    <div class="page">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="#"><img class="brand-logo-dark" src="images/logo-default-249x52.png" alt="" width="249" height="52"/><img class="brand-logo-light" src="images/logo-inverse-249x52.png" alt="" width="249" height="52"/></a>
                  </div>
                </div>
            ...
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row justify-content-start text-left">
                  <div class="col-12">
                    <h4 class="swiper-title-3" data-caption-animate="fadeInLeft" data-caption-delay="200">Welcome to Our Online Store</h4>
                    <h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">Grocery Store</h1>
                    <h3 class="swiper-title-2" data-caption-animate="fadeInRight" data-caption-delay="200">for true gourmets</h3>
                    <div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"><a class="button button-lg button-primary button-zakaria" href="grid_shop.php">Shop now</a></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="swiper-slide" data-slide-bg="images/slide-2.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row justify-content-start text-left">
                  <div class="col-12">
                    <h4 class="swiper-title-3" data-caption-animate="fadeInLeft" data-caption-delay="200">A Wide Selection of Artisan Bread</h4>
                    <h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">Baked goods</h1>
                    <h3 class="swiper-title-2" data-caption-animate="fadeInRight" data-caption-delay="200">available at our store</h3>
                    <div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"><a class="button button-lg button-primary button-zakaria" href="grid_shop.php">Shop now</a></div>
                  </div>
                </div>
              </div>
          ...
          <div class="swiper-slide" data-slide-bg="images/slide-3.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row justify-content-start text-left">
                  <div class="col-12">
                    <h4 class="swiper-title-3" data-caption-animate="fadeInLeft" data-caption-delay="200">Fresh and Tasty</h4>
                    <h1 class="swiper-title-1" data-caption-animate="fadeScale" data-caption-delay="100">vegetables</h1>
                    <h3 class="swiper-title-2" data-caption-animate="fadeInRight" data-caption-delay="200">that you love</h3>
                    <div class="button-wrap" data-caption-animate="fadeInUp" data-caption-delay="300"><a class="button button-lg button-primary button-zakaria" href="grid_shop.php">Shop now</a></div>
                  </div>
                </div>
              </div>
      ...
      <section class="section bg-default text-md-left section-md-inset">
        <div class="container">
          <div class="row row-30 align-items-center justify-content-center justify-content-xl-between">
            <div class="col-sm-6 col-md-5 col-lg-6 wow fadeInLeft"><img src="images/about-576x537.jpg" alt="" width="576" height="537"/>
            </div>
            <div class="col-md-7 col-lg-6 col-xl-5">
              <h4 class="title-style-1 wow fadeInRight">A Few Words About Our Store</h4>
              <h2 class="wow fadeInRight" data-wow-delay=".1s">About us</h2>
              <p class="offset-top-md-20 wow fadeInRight" data-wow-delay=".2s">Grocmart is a family-owned grocery store that has been offering quality products for your everyday life since 1999, while also providing superior service and competitive prices.</p>
              <div class="group-xl group-middle d-md-flex justify-content-md-between wow fadeInRight" data-wow-delay=".3s">
                <div>
                  <div class="group-xl group-middle"><a class="button button-sm button-icon-3 button-primary button-zakaria" href="about-us.html"><span class="mdi mdi-arrow-right"></span></a>
                    <div class="team-navy">
            ...
            <div class="row row-30 box-ordered">
              <div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay=".3s">
                <article class="box-icon-modern">
                  <div class="box-icon-modern-header">
                    <div class="box-icon-modern-icon linearicons-fish"></div>
                  </div>
                  <h4 class="box-icon-modern-title"><a href="#">quality products</a></h4>
                  <p class="box-icon-modern-text">We work with the best suppliers to offer our customers the fresh grocery products of the highest quality.</p>
                </article>
              </div>
              <div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay=".2s">
                <article class="box-icon-modern">
                  ...
                  <h4 class="box-icon-modern-title"><a href="#">Affordable prices</a></h4>
                  <p class="box-icon-modern-text">Thanks to our affordable pricing policy, our customers don’t have to overpay for the products they need.</p>
                </article>
              </div>
              <div class="col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay=".1s">
                <article class="box-icon-modern">
                  ...
                  <h4 class="box-icon-modern-title"><a href="#">Fast shipping</a></h4>
                  <p class="box-icon-modern-text">Our store offers fast worldwide shipping to all customers regardless of what and how much you order.</p>
                </article>
              </div>
              <div class="col-sm-6 col-lg-3 wow fadeInLeft">
                <article class="box-icon-modern">
                  ...
                  <h4 class="box-icon-modern-title"><a href="#">open 24/7</a></h4>
                  <p class="box-icon-modern-text">Unlike other grocery shops, we are ready to serve you 24/7 and offer the best selection of groceries.</p>
                </article>
              </div>
            </div>
          </div>
      ...
      <section class="section section-xxl bg-default">
        <div class="container">
          <h4 class="title-style-1 wow fadeInLeft">Latest Arrivals</h4>
            ...
            <div class="isotope-filters">
              ...
              <div class="isotope-filters-list-wrap">
                <ul class="isotope-filters-list">
                  ...
                  <li><a href="#" data-isotope-filter="Type 3">Bread</a></li>
                </ul>
              </div>
            </div>
      ...
      <!-- Our clients-->
      <section class="section section-xxl" style="background: url('images/bg-image-5.jpg') no-repeat; background-position: center; background-size:cover;">
        <div class="container">
          ...
          <div class="owl-carousel owl-style-3" data-items="1" data-margin="200" data-autoplay="true" data-nav="true" data-dots="true" data-smart-speed="400" data-animation-in="fadeIn" data-animation-out="fadeOut">
            ...
            <article class="quote-modern quote-modern-2">
              <div class="quote-modern-text">
                <div class="q">I just received my order and was truly amazed. It was packed so well and the items are wonderful. I am new to ordering food online but it was a great experience.</div>
              </div>
              <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                ...
                <div class="unit-body">
                  <div class="quote-modern-author">Kate Smith</div>
            ...
            <article class="quote-modern quote-modern-2">
              <div class="quote-modern-text">
                <div class="q">I got my large order of Raw Vegan foods in today via UPS and was very impressed with the packaging &amp; freshness as well as the quality of my meals.</div>
              </div>
              <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                <div class="unit-left">
            ...
            <article class="quote-modern quote-modern-2">
              <div class="quote-modern-text">
                <div class="q">I have to say I'm really impressed with my recent order. I've bought similar products from other sites before, but I chose you this time because of your great selection and prices.</div>
              </div>
              <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                <div class="unit-left">
      ...
      <section class="section section-xxl bg-default">
        <div class="container">
          <div class="row row-30">
            <div class="col-sm-7 wow fadeInLeft"><a class="banner-modern-figure" href="grid_shop.php"><img src="images/banner-2-670x676.jpg" alt="" width="670" height="676"/></a></div>
            <div class="col-sm-5"><a class="banner-modern-figure wow fadeInRight" href="grid_shop.php"><img src="images/banner-3-470x395.jpg" alt="" width="470" height="395"/></a><a class="banner-modern-figure wow fadeInRight" href="grid_shop.php"><img src="images/banner-4-470x250.jpg" alt="" width="470" height="250"/></a></div>
          </div>
        </div>
      </section>
      <section class="section parallax-container" data-parallax-img="images/parallax-6.jpg">
        <div class="parallax-content section-md context-dark darken-overlay">
          <div class="container">
            <div class="row">
              <div class="owl-carousel" data-items="2" data-sm-items="3" data-md-items="4" data-lg-items="5" data-margin="30" data-dots="true"><a class="clients-classic" href="#"><img src="images/clients-1-120x114.png" alt="" width="120" height="114"/></a><a class="clients-classic" href="#"><img src="images/clients-2-105x118.png" alt="" width="105" height="118"/></a><a class="clients-classic" href="#"><img src="images/clients-3-111x98.png" alt="" width="111" height="98"/></a><a class="clients-classic" href="#"><img src="images/clients-4-122x92.png" alt="" width="122" height="92"/></a><a class="clients-classic" href="#"><img src="images/clients-5-112x112.png" alt="" width="112" height="112"/></a></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row row-30 justify-content-center align-items-md-center">
            <div class="col-sm-8 col-md-5 col-xl-6">
              <div class="inset-xl-right-20">
                <div class="product-wrap-1 bg-image-1">
                  <!-- Owl Carousel-->
                  <div class="owl-carousel owl-style-5" data-items="1" data-margin="30" data-dots="true" data-autoplay="true">
                    <article class="product-creative">
                      <div class="product-figure"><img src="images/product-big-1-303x304.png" alt="" width="303" height="304"/>
                      </div>
                      <h4 class="product-creative-title"><a href="single-product.html">Sparkling juice</a></h4>
                    ...
                    <article class="product-creative">
                      <div class="product-figure"><img src="images/product-big-2-303x304.png" alt="" width="303" height="304"/>
                      </div>
                      <h4 class="product-creative-title"><a href="single-product.html">Whole Grain Bread</a></h4>
                      <div class="product-creative-price-wrap">
                    ...
                    <article class="product-creative">
                      <div class="product-figure"><img src="images/product-big-3-303x304.png" alt="" width="303" height="304"/>
                      </div>
                      <h4 class="product-creative-title"><a href="single-product.html">parmesan Cheese</a></h4>
                      <div class="product-creative-price-wrap">
            ...
            <div class="col-md-7 col-xl-6">
              <h4 class="title-style-1 wow fadeInRight">Common Questions</h4>
              ...
              <div class="card-group-custom card-group-custom-1 card-group-corporate" id="accordion1" role="tablist" aria-multiselectable="false">
                ...
                <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".2s">
                  <div class="card-header" role="tab">
                    <div class="card-title"><a id="accordion1-card-head-agvgdkvb" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-ctrrmhch" aria-controls="accordion1-card-body-ctrrmhch" aria-expanded="true" role="button">What do I receive when I order a template?
                        <div class="card-arrow">
                          <div class="icon"></div>
                        </div></a></div>
                  </div>
                  <div class="collapse show" id="accordion1-card-body-ctrrmhch" aria-labelledby="accordion1-card-head-agvgdkvb" data-parent="#accordion1" role="tabpanel">
                    <div class="card-body">
                ...
                <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".3s">
                  <div class="card-header" role="tab">
                    <div class="card-title"><a class="collapsed" id="accordion1-card-head-tdcejlvt" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-ssqmjbek" aria-controls="accordion1-card-body-ssqmjbek" aria-expanded="false" role="button">In what formats are your templates available?
                        <div class="card-arrow">
                          <div class="icon"></div>
                        </div></a></div>
                  </div>
                  <div class="collapse" id="accordion1-card-body-ssqmjbek" aria-labelledby="accordion1-card-head-tdcejlvt" data-parent="#accordion1" role="tabpanel">
                    <div class="card-body">
                ...
                <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".4s">
                  <div class="card-header" role="tab">
                    <div class="card-title"><a class="collapsed" id="accordion1-card-head-puvhsjfw" data-toggle="collapse" data-parent="#accordion1" href="#accordion1-card-body-qwcaslng" aria-controls="accordion1-card-body-qwcaslng" aria-expanded="false" role="button">What am I allowed to do with the templates?
                        <div class="card-arrow">
                          <div class="icon"></div>
                        </div></a></div>
                  </div>
                  <div class="collapse" id="accordion1-card-body-qwcaslng" aria-labelledby="accordion1-card-head-puvhsjfw" data-parent="#accordion1" role="tabpanel">
                    <div class="card-body">
      ...
      <section class="section section-sm section-last bg-default">
        <div class="container">
          <h4 class="title-style-1 wow fadeInRight">Latest News</h4>
          <h2 class="wow fadeScale">Our blog</h2>
        </div>
        <!-- Owl Carousel-->
        <div class="owl-carousel owl-style-7" data-items="1" data-sm-items="2" data-xl-items="3" data-xxl-items="4" data-nav="true" data-dots="true" data-margin="30" data-autoplay="false">
          <!-- Post Creative-->
          <article class="post post-creative"><a class="post-creative-figure" href="blog-post.html"><img src="images/post-4-420x368.jpg" alt="" width="420" height="368"/></a>
            <div class="post-creative-content">
              <h5 class="post-creative-title"><a href="blog-post.html">8 Useful Tips for Smart  <br> Grocery Shopping</a></h5>
          ...
          <!-- Post Creative-->
          <article class="post post-creative"><a class="post-creative-figure" href="blog-post.html"><img src="images/post-1-420x368.jpg" alt="" width="420" height="368"/></a>
            <div class="post-creative-content">
              <h5 class="post-creative-title"><a href="blog-post.html">How to Save Money When  <br> Shopping for Vegetables</a></h5>
              <div class="post-creative-time">
                <time datetime="2019-08-09">August 9, 2019</time>
              </div>
            </div>
          ...
          <!-- Post Creative-->
          <article class="post post-creative"><a class="post-creative-figure" href="blog-post.html"><img src="images/post-2-420x368.jpg" alt="" width="420" height="368"/></a>
            <div class="post-creative-content">
              <h5 class="post-creative-title"><a href="blog-post.html">Navigating The Grocery Store  <br> For Healthy Eating</a></h5>
              <div class="post-creative-time">
                <time datetime="2019-08-09">August 9, 2019</time>
              </div>
            </div>
          ...
          <!-- Post Creative-->
          <article class="post post-creative"><a class="post-creative-figure" href="blog-post.html"><img src="images/post-3-420x368.jpg" alt="" width="420" height="368"/></a>
            <div class="post-creative-content">
              <h5 class="post-creative-title"><a href="blog-post.html">5 Reasons to Choose Gro- <br>cmart for Your Shopping</a></h5>
              <div class="post-creative-time">
                <time datetime="2019-08-09">August 9, 2019</time>
              </div>
            </div>
          ...
          <!-- Post Creative-->
          <article class="post post-creative"><a class="post-creative-figure" href="blog-post.html"><img src="images/post-5-420x368.jpg" alt="" width="420" height="368"/></a>
            <div class="post-creative-content">
              <h5 class="post-creative-title"><a href="blog-post.html">Why People are Shopping for  <br>Groceries Online</a></h5>
              <div class="post-creative-time">
                <time datetime="2019-08-09">August 9, 2019</time>
              </div>
            </div>
