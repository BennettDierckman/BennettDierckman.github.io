...
<html lang="en-US">
    <head>
        ...
        <!--    Document Title-->
        <!-- =============================================-->
        <title>GFC | Call Request</title> <!-- Shows in browser tab -->
        <!--  -->
        <!--    Favicons-->
        <!--    =============================================-->
                            ...
                            <div class="background-white radius-secondary p-4 p-md-5 mt-0" data-zanim='{"delay":0.1}'>
                                ...
                                <div class="row text-left">
                                  ...
                                  <div class="col-10 mx-auto">
                                    <h5>Response:</h5>
                                    <form method="POST" action="send_callRequest_response.php">
                                      <textarea class="form-control background-white mb-3" rows="7" name="callRequest_response" id="callRequest_response" placeholder="Your Message" required></textarea>
                                      <div class="row">
                                        <div class="col-6">
