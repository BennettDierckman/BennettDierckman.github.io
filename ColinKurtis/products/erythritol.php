<?php 
	...
	$currentPage='products/erythritol.php';
	...
	$productInfo = getProductInfo('Erythritol');
	$productDescription = $productInfo[0]; 
	$productHex = $productInfo[1];
	$productImg = $productInfo[2];
		...
		<div class="page">
				...
				<div class="pageTitle d-flex flex-row flex-lg-column">
					...
					?>
				 	<div class="container d-none d-lg-block text-center">
				 		<h1 class="mt-2 mb-2">Erythritol</h1>
				 	</div>
				</div>
				<?php 
			...
			<main class="scroll">
				<article class="py-2 scroll articleBG">
					<?php 
					echo'
					<div class="contentBubble mx-auto p-3 mt-3 mt-md-3 mt-lg-5" style="background-color:'.$productHex.'">
					';
					?>
						<!-- Section Heading -->
						<h2>Erythritol</h2>
						...
						<div class="row">
							...
							<div class="col-12 col-md-5 col-lg-4 col-xl-3">
								<div class="productPage-productImg">
									<?php 
									echo
