<?php 
	...
	$currentPage='industries/food-industry/food-equipment-manufacturing.php';
...
<html lang="en">
	...
	<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
		<title>Food Equipment Manufacturing</title>
				...
				<div class="pageTitle d-flex flex-row flex-lg-column">
					...
					?>
				 	<div class="container d-none d-lg-block text-center">
				 		<h1 class="mt-2 mb-2">Food Equipment Manufacturing</h1>
				 	</div>
				</div>
				<?php 
			...
			<main class="scroll">
				<article class="py-2 scroll articleBG">
					<div class="contentBubble mx-auto p-3 mt-3 mt-md-3 mt-lg-5">
						<!-- Section Heading -->
						<h2>Food Equipment Manufacturing</h2>
