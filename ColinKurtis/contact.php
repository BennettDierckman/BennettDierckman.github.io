				...
				<div class="pageTitle d-flex flex-row flex-lg-column">
					...
					?>
				 	<div class="container d-none d-lg-block text-center">
				 		<h1 class="mt-2 mb-2">Contact National Food</h1>
				 	</div>
				</div>
				<?php 
			...
			<main class="scroll">
				<article class="py-2">
					<div class="contentBubble mx-auto p-3 mt-3 mt-md-3 mt-lg-5">
						<!-- Section Heading -->
						<h2>Contact the National Food Company</h2>
						...
						<ul>
							<li>800 588 2300 National Food company (today)</li>
							<li>natFoodComp@gmail.com</li>
							<li>m-f 5-10pm</li>
							<li class="unique">Closed Weekends!</li>
						</ul>
					</div>
					<div class="contentBubble mx-auto p-3 mt-3 mb-3">
						<!-- Section Heading -->
