<?php
    ...
    if ($count == 1){
        ...
        mysqli_stmt_bind_result($statement, $userID, $userFirstName, $userLastName, $userPhone, $userEmail, $userHash, $userRecoveryHash);
        while(mysqli_stmt_fetch($statement)){
            if (password_verify($password, $userHash)) {
                ...
                $_SESSION['userRecoveryHash'] = $userRecoveryHash;
