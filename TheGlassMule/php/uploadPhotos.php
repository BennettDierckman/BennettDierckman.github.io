		...
		<div class="container" style="background-color: #F2f3f4;">
			...
			<div class="row">
				<div class="col-12 col-md-11 col-lg-10 col-xl-9 mx-auto mt-3 mt-md-4 mt-lg-5">
					<div class="loginForm">
						<div class="row">
							<div class="col-11 col-sm-10 col-md-8 col-lg-4 mx-auto">
							    <a href="deleteItem.php" class="btn btn-danger mb-3" style="width: 100%;">Nevermind, Delete.</a>
							</div>
							<div class="col-11 col-sm-10 col-md-8 col-lg-4 mx-auto">
							    <a href="'.$previousPage.'" class="btn btn-warning" style="width: 100%;">Go Back</a>
							</div>
							<div class="col-11 col-sm-10 col-md-8 col-lg-4 mx-auto">
							    <button type="submit" class="btn btn-secondary mb-3" style="width: 100%;">Add to Site</button>
							</div>
						</div>
					</div>
				</div>
