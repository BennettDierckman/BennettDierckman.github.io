					...
					<div class="loginForm">
						<div class="row">
							...
							<div class="d-none d-lg-block col-lg-11 mx-auto">
								<h3 clas="mb-1">Rigs</h3>';
							  	$sql1="SELECT * FROM items WHERE category='Rigs' ORDER BY relevance DESC";
							  	$result1 = $mysqli->query($sql1);
                                $numRows1 = $result1->num_rows;
                                //if there are employees in the users table 
                                if ($numRows1 > 0){
                                	echo '<span class="mb-5" style="display: flex; justify-content: center;"><table border=1>
                                			<tr>
							...
							<div class="d-none d-lg-block col-lg-11 mx-auto">
								<h3 clas="mb-1">Dry Pipes</h3>';
							  	$sql1="SELECT * FROM items WHERE category='Dry Pipes' ORDER BY relevance DESC";
							  	$result1 = $mysqli->query($sql1);
                                $numRows1 = $result1->num_rows;
                                //if there are employees in the users table 
                                if ($numRows1 > 0){
							...
							<div class="d-none d-lg-block col-lg-11 mx-auto">
								<h3 clas="mb-1">Water Pipes</h3>';
							  	$sql1="SELECT * FROM items WHERE category='Water Pipes' ORDER BY relevance DESC";
							  	$result1 = $mysqli->query($sql1);
                                $numRows1 = $result1->num_rows;
                                //if there are employees in the users table 
                                if ($numRows1 > 0){
							...
							<div class="d-none d-lg-block col-lg-11 mx-auto">
								<h3 clas="mb-1">Pendants</h3>';
							  	$sql1="SELECT * FROM items WHERE category='Pendants' ORDER BY relevance DESC";
							  	$result1 = $mysqli->query($sql1);
                                $numRows1 = $result1->num_rows;
                                //if there are employees in the users table 
                                if ($numRows1 > 0){
							...
							<div class="d-none d-lg-block col-lg-11 mx-auto">
								<h3 clas="mb-1">Marbles</h3>';
							  	$sql1="SELECT * FROM items WHERE category='Marbles' ORDER BY relevance DESC";
							  	$result1 = $mysqli->query($sql1);
                                $numRows1 = $result1->num_rows;
                                //if there are employees in the users table 
                                if ($numRows1 > 0){
							...
							<div class="d-none d-lg-block col-lg-11 mx-auto">
								<h3 clas="mb-1">Dabbers</h3>';
							  	$sql1="SELECT * FROM items WHERE subCategory='Dabbers' ORDER BY relevance DESC";
							  	$result1 = $mysqli->query($sql1);
                                $numRows1 = $result1->num_rows;
                                //if there are employees in the users table 
                                if ($numRows1 > 0){
							...
							<div class="d-none d-lg-block col-lg-11 mx-auto">
								<h3 clas="mb-1">Carb Caps</h3>';
							  	$sql1="SELECT * FROM items WHERE subCategory='Carb Caps' ORDER BY relevance DESC";
							  	$result1 = $mysqli->query($sql1);
                                $numRows1 = $result1->num_rows;
                                //if there are employees in the users table 
                                if ($numRows1 > 0){
							...
							<div class="d-none d-lg-block col-lg-11 mx-auto">
								<h3 clas="mb-1">Dab Mats</h3>';
							  	$sql1="SELECT * FROM items WHERE subCategory='Dab Mats' ORDER BY relevance DESC";
							  	$result1 = $mysqli->query($sql1);
                                $numRows1 = $result1->num_rows;
                                //if there are employees in the users table 
                                if ($numRows1 > 0){
							...
							<div class="d-none d-lg-block col-lg-11 mx-auto">
								<h3 clas="mb-1">Glass Protection</h3>';
							  	$sql1="SELECT * FROM items WHERE subCategory='Glass Protection' ORDER BY relevance DESC";
							  	$result1 = $mysqli->query($sql1);
                                $numRows1 = $result1->num_rows;
                                //if there are employees in the users table 
                                if ($numRows1 > 0){
