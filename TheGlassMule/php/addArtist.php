		...
		<div class="container" style="background-color: #F2f3f4;">
			...
			<div class="row">
				<div class="col-12 col-md-11 col-lg-10 col-xl-9 mx-auto mt-3 mt-md-4 mt-lg-5">
					<div class="loginForm">
						<div class="row">
							<div class="d-none d-lg-block col-lg-11 mx-auto mt-5">
								<h3 class="text-center mt-4 mb-2">Register a new Artist.</h3>
								<form method="post" enctype="multipart/form-data" action="registerArtist.php">
								  <div class="form-group">
								    <input type="text" class="form-control" style="width:75%; margin-left:auto; margin-right:auto;" id="artistName" name="artistName" placeholder="Artist\'s Name" required>
								  </div>
								  <div class="form-group d-flex">
								    <input type="text" class="form-control" style="width:75%; margin-left:auto; margin-right:auto;" id="artistMedia" name="artistMedia" placeholder="Artist\'s Media Link" required>
								  </div>
								  <div class="row mt-2 mb-3">
								  	<div class="col-6 px-auto">
									  <a href="'.$previousPage.'" class="btn btn-danger" style="width: 300px !important; float:right;">Go Back</a>
									</div>
									<div clas="col-6 px-auto">
									  <button type="submit" class="btn btn-primary" style="width: 300px !important; float:right;">Continue</button>
									</div>
								  </div>
								</form>
							</div>
		...
		$(document).ready(function() {
			...
			$(add_button).click(function(e){ //on add input button click
				...
				if(x < max_fields){ //max input box allowed
					...
					$(wrapper).append(\'<div><input style="height: 39px; font-size: 16px; color: white; margin-bottom:5px; margin-right: 5px;" class="btn btn-info" type="file" name="itemPics[]"><a href="#" class="remove_field">Remove</a></div>\'); //add input box
				}
			});
