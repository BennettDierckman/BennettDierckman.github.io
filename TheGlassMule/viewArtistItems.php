...
$artistID = $mysqli->escape_string($_GET["artistId"]);
			...
			<div class="row">
				...
				<div class="col-sm-8 col-md-8 p-l-0 p-r-0 col-lg-9 p-b-50">
					...
					<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(images/logos/LemonBack.jpg);">
						<h2 class="p-t-30 l-text2 t-center">'.$artistName.'</h2>
					</section>

					<!-- Product -->
					<div class="row p-l-3 p-r-3">';
						$itemSQL="SELECT * FROM items WHERE artistName LIKE '% $artistID, %' ORDER BY relevance DESC";	
