<?php
    ...
    $statement = $mysqli->prepare("SELECT * FROM serviceRequests WHERE id=?"); 
    mysqli_stmt_bind_param($statement, "s", $serviceRequest_id);
    ...
    if ($count == 1){
        ...
        mysqli_stmt_bind_result($statement, $result_id, $result_name, $result_email, $result_company, $result_title, $result_message, $result_requestedServiceCategory, $result_requestedService, $result_requestDate, $result_responder, $result_responseDate);
        while(mysqli_stmt_fetch($statement)){
          ...
          $requestedServiceCategory = $result_requestedServiceCategory;
          $requestedService = $result_requestedService;
          $requestDate = $result_requestDate;
      ...
      $_SESSION['message'] = "Unable to locate service request in database."; //set error message
...
<html lang="en-US">
    <head>
        ...
        <!--    Document Title-->
        <!-- =============================================-->
        <title>GFC | Service Request</title> <!-- Shows in browser tab -->
        <!--  -->
        <!--    Favicons-->
        <!--    =============================================-->
                    ...
                    <div class="row h-full align-items-center">
                        <div class="col-lg-10 mx-auto" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                            <div class="background-white radius-secondary p-4 p-md-5 mt-0" data-zanim='{"delay":0.1}'>
                                ...
                                <hr>
                                <h3 class="fs-2 mb-3">Responding to Service Request</h3> 
                                <div class="row text-left">
                                  <div class="col-4">
                                    <h5 class="mb-0">From:</h5>
                                    <p><?php echo $name; ?></p>
                                    <h5 class="mb-0">Date Recieved:</h5>
                                    <p><?php echo $requestDate; ?></p>
                                  </div>
                                  <div class="col-3">
                                  ...
                                  <div class="col-5">
                                    <h5 class="mb-0">Requested Category:</h5>
                                    <p><?php echo $requestedServiceCategory; ?></p>
                                    <h5 class="mb-0">Requested Service:</h5>
                                    <p><?php echo $requestedService; ?></p>
                                  </div>
                                  ...
                                  <div class="col-10 mx-auto">
                                    <h5>Response:</h5>
                                    <form method="POST" action="send_serviceRequest_response.php">
                                      <textarea class="form-control background-white mb-3" rows="7" name="serviceRequest_response" id="serviceRequest_response" placeholder="Your Message" required></textarea>
                                      <div class="row">
                                        <div class="col-6">
                                          <a href="mainDashboard.php" class="btn btn-danger btn-block w-100">Cancel</a>
                                        </div>
                                        <div class="col-6">
                                          <?php echo '<input type="hidden" name="serviceRequest_id" value="'.$id.'">' ?>
                                          <?php echo '<input type="hidden" name="serviceRequest_email" value="'.$email.'">' ?>
