...
<html lang="en-US">
    <head>
        ...
        <!--    Document Title-->
        <!-- =============================================-->
        <title>GFC | Schedule Call</title> <!-- Shows in browser tab -->
        <!--  -->
        <!--    Favicons-->
        <!--    =============================================-->
                    ...
                    <div class="row h-full align-items-center">
                        <div class="col-lg-10 mx-auto" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                            <div class="background-white radius-secondary p-4 p-md-5 mt-0" data-zanim='{"delay":0.1}'>
                                ...
                                <hr>
                                <h3 class="fs-2 mb-3">Schedule Call with Prospect</h3> 
                                <div class="row text-left">
                                  ...
                                  <div class="col-10 mx-auto">
                                    <h5>Schedule Call</h5>
                                    <form method="POST" action="send_callRequest_schedulingResponse.php">
                                      <textarea class="form-control background-white mb-3" rows="1" name="callRequest_scheduledDate" id="callRequest_scheduledDate" placeholder="mm/dd/yy hh:mm:ss" required></textarea>
                                      <div class="row">
                                        <div class="col-6">
